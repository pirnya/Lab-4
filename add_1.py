# Доп. задание: Найти решение или доказать его отсутствие для случая с инвентарём в 7 ячеек.
# Ответ: решение отсутствует, т.к. при самом оптимальном решении итоговые очки выживания получаются отрицательными
...
i=0
for lenght in range(1): #выводим предметы (2x4 размер)
